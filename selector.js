...
session_added = function(type, id, server) {
...
test_logexchange = function(server, callback, err) {
...
test_logexchange_ui = function() {
  var server;
  server = $("#addServer").val();
  if (verified_servers[server]) {
    return;
  }
  return test_logexchange(server, function() {
    $("button#addButton");
...
$(document).bind({
  'xmpp-connected': function(ev, data) {
  ...
  'xmpp-disconnected': function(ev, data) {}
});
...
init_ui = function() {
  ...
  $("button#addButton").click(test_logexchange_ui);
  ...
  $("#sendStanza").click(function() {
    ...
    active_cmd.complete({
      ...
      success: function(stanza, cmd) {
        ...
        return session_added("stanzalog", logid, cmd.jid);
      }
    });
    $("div#StanzaFormDiv").hide();
    return $("div#ServerDiv").show();
  ...
  $("#sendStatus").click(function() {
    ...
    active_cmd.complete({
      responseForm: response_form,
      success: function(stanza, cmd) {
        return session_added("statuslog", logid, cmd.jid);
      }
    });
    $("div#StatusFormDiv").hide();
    return $("div#ServerDiv").show();
